    ...
    class Initialization
    {
        public static bool onInit()
        {
            try
            {
                ...
                {
                    GlobalVariable.strSQLSettings = GlobalVariable.strConPath + "SQL_ConnectSettings.ini";
                    GlobalVariable.strSMTPSettings = GlobalVariable.strConPath + "E-Mail_ConnectSettings.ini";
                    GlobalVariable.strAPISettings = GlobalVariable.strConPath + "API_ConnectSettings.ini";
                    GlobalVariable.strSFTPSettings = GlobalVariable.strConPath + "FTP_ConnectSettings.ini";
